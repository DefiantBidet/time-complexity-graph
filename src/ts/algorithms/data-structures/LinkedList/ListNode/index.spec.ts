...
describe('LinkedList/ListNode', () => {
  test('ListNode constructor should create ListNode with only `value` parameter supplied', () => {
    const mockValue = 100;
  ...
  test('ListNode constructor should create ListNode with referential types', () => {
  ...
  test('ListNode constructor should link nodes by supplying `next` parameter', () => {
  ...
  test('ListNode `toString` should convert ListNode to string', () => {
  ...
  test('ListNode `toString` should convert ListNode to string via `callbackFn`', () => {
    const nodeValue: MockType = {
      value: 99,
      label: 'foo!'
    };
